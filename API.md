...
| <code><a href="#image-scanner-with-trivy.ImageScannerWithTrivy.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### ~~`with`~~ <a name="with" id="image-scanner-with-trivy.ImageScannerWithTrivy.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="image-scanner-with-trivy.ImageScannerWithTrivy.with.parameter.mixins"></a>
...
| <code><a href="#image-scanner-with-trivy.ImageScannerWithTrivyV2.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="image-scanner-with-trivy.ImageScannerWithTrivyV2.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="image-scanner-with-trivy.ImageScannerWithTrivyV2.with.parameter.mixins"></a>
